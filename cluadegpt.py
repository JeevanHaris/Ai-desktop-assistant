...
def listen():
    try:
        ...
        speak("There was an error with the microphone. Please try again.")
        return ""
...
def handle_command(command):
    ...
    if 'time' in command and ('current' in command or 'what' in command):
        ...
        print(f"Responding with help: {help_text}")
        speak(help_text)
        
    else:
        # Use AI for general conversation
        print("Using AI response for general conversation")
        try:
...
def assistant_loop():
    ...
    print("Assistant started. Listening for commands...")
    ...
    while True:
        try:
            ...
            if command:
                ...
                print("No command received or empty command")
